	...
	<div class="main_content" style="background-color:#fff;">
		...
		<div class="col-md-12">
			<div class="box1" style="float: left;margin-left: 325px;">
				<h4 class="text-center;" ><a href="patient_login.php" style="text-decoration: none;color:red;">I am Client</a></h4>
			</div>
			
			<div class="box2" style="float: right;margin-right: 385px;">
				<h4 class="text-center;"><a href="#" style="text-decoration: none;color:red;">I am Mechanic</a></h4>
			</div>
