	...
	<div class="recipient_reg" style="background-color:#272327;">
		...
		<form enctype="multipart/form-data" method="post" class="text-center" style="margin-left: 110px">
			 <div class="col-md-12">
			 		...
			 		<label>
					    <input type="text" name="mechanic_id" value="" placeholder="mechanic_id" required>
					</label><br><br>
					<label>
 ...
 <!-- validation and insertion -->
			...
			<?php
						...
						if(isset($_POST['submit'])){
							...
							$sql = "INSERT INTO mechanic (mechanic_id,name,address,contact,email,expertise,id)
							VALUES ('" . $_POST["mechanic_id"] ."','" . $_POST["name"] . "','" . $_POST["address"] . "','" . $_POST["contact"] . "','" . $_POST["email"] . "', '" . $_POST["expertise"] . "','" . $_POST["id"] . "' )";
