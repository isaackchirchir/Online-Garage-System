	...
	<div class="recipient_reg" style="background-color:#272327;">
		...
		<form enctype="multipart/form-data" method="post" class="text-center" style="margin-left: 110px">
			 <div class="col-md-12">
			 		...
			 		<label>
					    <input type="text" name="mechanic_id" value="" placeholder="mechanic_id" >
					</label><br><br>
					<label>
			...
			<?php
				...
				//aloow certain file formats
					...
					// if (move_uploaded_file ($_FILES['t8']['tmp_name'], "/doner_pic/{$_FILES['t8']['name']}")) {
						include('../config.php');
							$s="INSERT INTO mechanic(name,address,contact,email,expertise,userid,pic) VALUES('" . $_POST["name"] . "','" . $_POST["address"] . "','" . $_POST["contact"] . "','" . $_POST["email"] . "', '" . $_POST["expertise"] . "','" . $_POST["userid"] . "','" . basename($_FILES["t8"]["name"])  ."')";
