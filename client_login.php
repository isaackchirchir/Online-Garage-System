...
<?php include('header.php'); ?>
	...
	<div class="login" style="background-color:#fff;">
		<h3 class="text-center" style="background-color:#272327;color: #fff;">Client Login</h3>
			<div class="formstyle" style="float: right;padding:20px;border: 1px solid lightgrey;margin-right:415px; margin-bottom:30px;background-color:#f3f3f8;color:#141313;">
				<form action="" method="post" class="text-center form-group">
					...
					<span style="color:#000;">Not a member yet?</span> <a href="client_reg.php" title="create a account" target="" style="color:#000;">&nbsp;Sign Up</a> <br>
					...
					$_SESSION['patient']="";
							...
							$result = $conn->query($sql);
									...
									if ($result->num_rows > 0) {
										    ...
										    echo "<script>location.replace('client/dashboard.php');</script>";
