...
<head>
	...
	<title>Wazito management system</title>
...
<div class="container-fluid">
	...
	<div class="login" style="background-color:#fff;">
		<h1 class="text-center" style="background-color:#272327;color: #fff;">Mechanic Panel</h1>
			...
			<?php 
							...
							$sql= "SELECT * FROM mechanic WHERE userid= '" . $_POST["userid"]."' AND password= '" . $_POST["password"]."'";
