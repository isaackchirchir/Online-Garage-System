...
<!-- for retriving data -->
				<?php 
							include('../config.php');
							$sql="SELECT * FROM mechanic where userid='" . $_SESSION["userid"] . "'";
			...
			<!-- update information -->
				...
				<?php
						...
						if(isset($_POST['submit'])){
							...
							$sql="UPDATE mechanic SET name='" .$_POST["name"]. "' ,address='" .$_POST["address"]."' , contact='" .$_POST["contact"]. "',email='" .$_POST["email"]. "' ,pic='" .$_POST["pic"]. "' WHERE userid='" . $_SESSION["userid"] . "'";
