	...
	<div class="contactus"  style="background-color:#fff;">
		...
		<div class="main_content">
			<div class="col-md-6" style="border-right: 2px solid black;">
				<article>
					<h2>Wazito Group of Garage<h2>
							<h5>Located at Ongata Rongai, along Magadi Road</h5>
						<p> https://www.wazitogarage.com <br>
	
							https://facebook/wazito garage <br>
							cell: +254 72565624</p><br>
				</article>
			</div>
			<div class="col-md-6">
